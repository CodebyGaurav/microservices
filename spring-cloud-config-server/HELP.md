...
* The original package name 'com.codebygaurav.spring-cloud-config-server' is invalid and this project uses 'com.codebygaurav.springcloudconfigserver' instead.
